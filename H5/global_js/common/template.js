                ...
                onSuccess: function(data) {
                    ...
                    if (data && data.length > 0) {
                        data.map(function(item) {
                            ...
                            item.id ? newitem.id = item.id.trim() : '';
        ...
        head: {
            ...
            initStyle: function() {
                var headStyle = [
                    ...
                    '.v-navbar .navigate-left:after { content:""; position:absolute; display:block; left:50%; top:50%; width:0.2rem; height:0.2rem; border-right:solid 2px #666; border-bottom:solid 2px #666; -webkit-transform:translate(-25%, -50%) rotate(135deg); transform:translate(-25%, -50%) rotate(135deg); }',
                    ...
                    '.v-navbar .navigate-share { float:right; width:0.6rem; height:0.88rem; background:url(/static/images/event/share.jpg) no-repeat center center; background-size:0.4rem 0.4rem; }',
                    '</style>'
                ].join('\n');
