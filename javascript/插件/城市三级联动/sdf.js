...
{
    var cmbProvince = document.getElementById(_cmbProvince);//省
    var cmbCity = document.getElementById(_cmbCity);//市
    var cmbArea = document.getElementById(_cmbArea);//区

    function cmbSelect(cmb, str)  //设置初始值
    {
    ...
    function cmbAddOption(cmb, str, obj)
    {
        ...
        cmb.options.add(option);//添加option
    ...
    function changeCity() {
        cmbArea.options.length = 0; //区域option的长度为0；
        if(cmbCity.selectedIndex == -1)return;//如果市的个数为-1返回；
    ...
    for(var i=0; i<provinceList.length; i++) //遍历provinceList
    {
