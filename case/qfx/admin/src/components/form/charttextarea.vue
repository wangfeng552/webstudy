<template>
	<div>
		<div class="chartinputCont charttextareaCont">
            <div class="chartTop">
            ...
            <div class="bigBox">
                <div class="itemsP">
                    ...
                    <span class="itemsLeft2">多行文本</span>
    ...
    export default{
        ...
        methods:{
            ...
            addGuize(){
                ...
                window.localStorage.setItem('check3', JSON.stringify(this.checked))
            },
            inputBlur(){
