<template>
  <div class="bgfff">
    <div class="gd-box" v-if="type=='one'">
      ...
      <div class="content">
        <p class="fs14 fc5c5 mt18 mb18">合同签署流程：</p>
        <div class="sign-flow">
          <ul class="clearfix">
            <li>
    ...
    <div class="gd-box" v-if="type=='two'">
      <div class="title bgf1b">
        <i class="tit-fqht01"></i>
        <span class="describe fcfff">{{ticket.title}}</span>
        <div class="status"><i class="icon-status icon-wait"></i> <span >等待处理</span></div>
      </div>
      <div class="content">
        <p class="fs14 fc5c5 mt18 mb18">合同签署流程：</p>
        <div class="sign-flow">
    ...
    <div class="gd-box" v-if="type=='three'">
      ...
      <div class="content">
        ...
        <p class="grey-border"></p>
        <p class="fs14 fc5c5 mt20 mb20"><span class="mr20">快递信息</span>
...
<script>
  ...
  export default{
    props: ['type','ticket','index','applyYear'],
    data(){
      return {
        input: '',
        textarea: '',
