export default function(elementNode, config) {
  ...
  this.html = function(type) {
    ...
    if (type === 1) {
      var html =
        '<div id="nativeShare"><div class="label"><span class="title">分享至：</span><span class="close"></span></div>' +
      ...
      var html =
        '<div id="nativeShare"><div class="label"><span class="title">分享至：</span><span class="close"></span></div>' +
        '<div class="list clearfix">' +
        '<div class="intro">复制下方链接，去粘贴给好友吧：</div>' +
        '<a href="' +
        this.url +
        '" target="_blank">' +
        '<div class="url"><span>' +
      ...
      var html =
        '<div class="closewx">' + '<div class="wxshare"></div>' + "</div>";
    }
  ...
  this.is_huawei_default = function() {
    var a = UA.toLowerCase();
    if (/HUAWEI/i.test(a)) {
