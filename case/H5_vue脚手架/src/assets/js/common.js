...
export var jsBridge = (function () {
  ...
  return {
    ...
    callClipboard: function (obj) {
      WebViewJavascriptBridge.callHandler('callClipboard', { data: obj.data }, function (response) { });
    },
    phoneCall: function (obj) {
      WebViewJavascriptBridge.callHandler('phoneCall', { phone: obj.phone }, function (response) { });
    },
