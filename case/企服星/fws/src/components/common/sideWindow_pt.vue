    ...
    <div class="opinion">
      ...
      <div v-if="supperAdmin">
        ...
        <div class="mascot-b" v-else="" :key="2">
          <div class="mas-t" @click="hideMascotB()">
    ...
    methods: {
      ...
      lookProduct(id, tag){
        this.$http.get(API.url + 'messages/' + id + '/read').then((res) => {
          ...
          var id = project.id;
          var first_stage_id = project.first_stage_id;
          var process_stage_id = project.process_stage_id;
          if(tag=='project_assign'){
            ...
            if (status == 'proceeding') {
              if (tag == 'audit_form') {
                this.$router.push({
                  name: 'auditForm',
                  params: {id: id, state_id: process_stage_id},
              ...
              this.$router.push({
                name: 'serviceApply',
                params: {id: id, state_id: first_stage_id},
                query: {name: this.stage_name}
              })
            }
          }
  ...
  .opinion {
    ...
    .mascot-b {
      ...
      .mas-t {
        ...
        width: 154px;
        height: 91px;
        background: url("./images/cw_2.png") center 0 no-repeat;
        z-index: 5;
        cursor: pointer;
        &:hover {
          .tishi {
